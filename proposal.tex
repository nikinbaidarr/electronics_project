...
current diagnostic procedures in psychiatry. Therefore, an imaging
basis is necessary for the diagnosis of mental disorders.

Before treatment for depression is begun, a health care professional
conducts a diagnosis based on specific patterns of behaviour and in
some cases, a physical examination may also be conducted to rule out
some other medical condition that may cause depression like symptoms,
such as thyroid problems, a brain tumor or vitamin deficiency. For
example, a blood test might be done to ensure the symptoms are not due
to thyroid related conditions.
