...
have been present as a bare minimum during span of 2 weeks.  % insert
WHO reference here

% MDD usually occurs in conjunction with other psychiatric problems such
% as anxiety and Post Traumatic Stress Disorder (PTSD). Anxiety can have
% a major impact on the course of a depressive illness, with delayed
% recovery, increased risk of relapse, greater disability and increased
% suicidal thoughts.
...
% The risk factors involved in depression are:

% \begin{itemize}[nosep]

  % \item Biochemistry: Elevation in certain chemicals such as serotonin
    % in the brain may contribute to symptoms of depression.

  % \item Genetics: Depression can be inherited.

  % \item Personality: People with low self-esteem, and those who are
    % easily overwhelmed by stress, or who are generally pessimistic are
    % more likely to experience depression.

  % \item Environmental Factors: continuous exposure to violence, or
    % abuse may make a person more vulnerable to depression.

% \end{itemize}

% Depression is also one of the most prevalent mental illness in Nepal.
...
Resting-state connectivity (RSC) may be defined as significant
...
several features of resting- state fMRI that it makes it a
particularly attractive method for investigating the neural correlates
of psychiatric and neurological disorders. First, compared to the
...
eases the cognitive demand of the fMRI environment, thereby
